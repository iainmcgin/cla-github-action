...
export default async function signatureWithPRComment(
    ...
    */
    const onlyCommitters = committers.filter((committer: CommittersDetails) => filteredListOfPRComments.some(commentedCommitter => committer.id == commentedCommitter.id))
